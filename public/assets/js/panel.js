                        ...
                        $.each(res.data, function (x, y) {
                            if ($("input[name='" + x + "']").is(":radio")) {
                                ...
                                fileInfoContainer.html(
                                    `<a href="/${module.toLowerCase()}/${fileName}" target="_blank" class="btn btn-outline btn-outline-dashed btn-outline-danger btn-active-light-danger p-2 py-1">
                                ...
                                logoInfoContainer.html(`<img id="img-foto" src="/${module.toLowerCase()}/${fileName}" style="max-width:100%;">`);
    ...
    push_select_album(url, element) {
        $.ajax({
            ...
            success: function (res) {
                ...
                $.each(res.data, function (x, y) {
                    if (y.status === 'Aktiv') {
                        html += `<option value="${y.uuid}">${y.nama_album}</option>`;
                    }
                });
                $(element).html(html);
            },
