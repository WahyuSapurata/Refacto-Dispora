                        ...
                        $.each(res.data, function(x, y) {
                            if ($("input[name='" + x + "']").is(":radio")) {
                                ...
                                fileInfoContainer.html(
                                    `<a href="/sarana/${fileName}" target="_blank" class="btn btn-outline btn-outline-dashed btn-outline-danger btn-active-light-danger p-2 py-1">
                                ...
                                logoInfoContainer.html(
                                    `<img id="img-foto" src="/sarana/${fileName}" style="max-width:50%;">`
                                );
