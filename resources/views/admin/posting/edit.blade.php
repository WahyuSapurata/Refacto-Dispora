...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/manajemen-artikel/update-posting/' + lastPart,
                ...
                success: function(response) {
                    ...
                    if (response.success == true) {
                        swal
                            ...
                            .then(function() {
                                window.location.href = '/admin/manajemen-artikel/posting';
                            });
                    } else {
                        $("form")[0].reset();
        ...
        $(function() {
            ...
            control.push_select2('/admin/manajemen-artikel/get-kategori', '#from_select_kategori');

            $.ajax({
                url: '/admin/manajemen-artikel/show-posting/' + lastPart,
                method: "GET",
                        ...
                        $.each(res.data, function(x, y) {
                            if ($("input[name='" + x + "']").is(":radio")) {
                                ...
                                logoInfoContainer.html(
                                    `<img id="img-foto" src="/posting/${fileName}" style="max-width:50%;">`
                                );
