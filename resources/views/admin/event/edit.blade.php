                        ...
                        <div class="card-body hover-scroll-overlay-y">
                            <form class="form-data" enctype="multipart/form-data">
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="text" id="tanggal" class="form-control kt_datepicker_7"
                                        name="tanggal">
                                ...
                                <div class="mb-10">
                                    ...
                                    <select name="kategori" class="form-select" data-control="select2"
                                        id="from_select_event" data-placeholder="Pilih jenis inputan">
                                    </select>
...
@section('script')
    <script>
        ...
        $(function() {
            ...
            control.push_select3(event, '#from_select_event');

            $.ajax({
                url: '/admin/show-event/' + lastPart,
                method: "GET",
                success: function(res) {
                    if (res.success) {
                        $.each(res.data, function(x, y) {
                            if ($("input[name='" + x + "']").is(":radio")) {
                                ...
                                fileInfoContainer.html(
                                    `<a href="/event/${fileName}" target="_blank" class="btn btn-outline btn-outline-dashed btn-outline-danger btn-active-light-danger p-2 py-1">
                                ...
                                logoInfoContainer.html(
                                    `<img id="img-foto" src="/event/${fileName}" style="max-width:50%;">`
                                );
                        ...
                        var konten = res.data.konten;
                        var tanggal = res.data.tanggal;

                        // Set konten ke dalam textarea dengan id "konten"
                        $("#konten").val(konten);
                        $(".kt_datepicker_7").val(tanggal);
