            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="nama_galeri" class="form-control" name="nama_galeri">
                        <small class="text-danger nama_galeri_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <select name="uuid_album" class="form-select" data-control="select2" id="from_select_album"
                            data-placeholder="Pilih jenis inputan">
                        </select>
                        <small class="text-danger uuid_album_error"></small>
                    </div>

                    <div class="mb-5">
                        <label class="form-label">Foto</label>
                        <input class="form-control" accept="image/*" type="file" name="foto" id="foto">
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Galeri');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/manajemen-media/add-galeri', 'Tambah',
                    'Galeri',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/manajemen-media/update-galeri/' + uuid,
                    'Update',
                    'Galeri', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/manajemen-media/show-galeri/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Galeri', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/manajemen-media/delete-galeri/' + $(this).attr('data-uuid');
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/admin/manajemen-media/get-galeri',
                columns: [{
                    data: null,
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        result =
                            `
                                <!--begin::Overlay-->
                                <a class="d-block overlay fancybox" data-fancybox="lightbox-group" href="{{ asset('/galeri/${data}') }}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="background-image:url('/galeri/${data}')">
                                    </div>
                                    <!--end::Image-->
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Kategori" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        $(function() {
            ...
            control.push_select_album('/admin/manajemen-media/get-album', '#from_select_album');
        });
    </script>
@endsection
