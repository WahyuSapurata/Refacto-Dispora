...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/manajemen-artikel/add-kategori', 'Tambah',
                    'Kategori',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/manajemen-artikel/update-kategori/' + uuid,
                    'Update',
                    'Kategori', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/manajemen-artikel/show-kategori/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Kategori', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/manajemen-artikel/delete-kategori/' + $(this).attr('data-uuid');
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/admin/manajemen-artikel/get-kategori',
                columns: [{
                        data: null,
